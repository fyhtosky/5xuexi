 ...
 * 课程详情 视频播放页面  评论接口 -好评
 */
public class CommentGoodFragment extends Fragment implements HttpDemo.HttpCallBack,AutoListView.OnRefreshListener,AutoListView.OnLoadListener{
    String TAG="comment";
    HttpDemo demo;
    ...
    private void getHttpDate(int page,int flag){
        ...
        pairsList.add(new Pairs("commentType",commentType+""));//评价对象类型 0：专业1公开课
        if(type>0){
