...
public class PickerView extends View
{
    ...
    private void drawData(Canvas canvas)
    {
        ...
        float size = (mMaxTextSize - mMinTextSize) * scale + (mMinTextSize/2.0f);
        ...
        canvas.drawText(mDataList.get(mCurrentSelected).getShowStr(), x, baseline, mPaint);
        // 绘制上方data
    ...
    private void drawOtherText(Canvas canvas, int position, int type)
    {
        ...
        Paint.FontMetricsInt fmi = mPaint.getFontMetricsInt();
        float baseline = (float) (y - (fmi.bottom / 2.0 + fmi.top / 2.0));
        canvas.drawText(mDataList.get(mCurrentSelected + type * position).getShowStr(),
