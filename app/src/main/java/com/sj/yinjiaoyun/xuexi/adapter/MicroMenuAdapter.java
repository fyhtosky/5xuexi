 ...
 * 微专业  切换
 */
public class MicroMenuAdapter  extends BaseAdapter {


    private Activity activity;//上下文
    private List<TrainingVO> list;

    private LayoutInflater inflater=null;//导入布局
    private int temp=-1;

    public MicroMenuAdapter(Activity context, List<TrainingVO> list) {
    ...
    public void fresh(List<TrainingVO> list){
        this.list=list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //设置list的textview显示
        TrainingVO trainingVO =  list.get(position);
        holder.cb.setText(trainingVO.getTrainingName()+"");
