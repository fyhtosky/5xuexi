 ...
 * 课程详情 视频播放页面  评论接口 -中评
 */
public class CommentOkayFragment extends Fragment implements HttpDemo.HttpCallBack,AutoListView.OnRefreshListener,AutoListView.OnLoadListener {
    String TAG="comment";
    HttpDemo demo;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View convertView=inflater.inflate(R.layout.fragment_comment_okey,container,false);
    ...
    private void getHttpDate(int page,int flag){
        ...
        pairsList.add(new Pairs("commentType",commentType+""));//评价对象类型 0：专业 1公开课
        if(type>0){
