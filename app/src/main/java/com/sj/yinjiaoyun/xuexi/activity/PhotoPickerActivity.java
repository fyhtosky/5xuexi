...
import com.sj.yinjiaoyun.xuexi.adapter.PhotoAdapter;
...
public class PhotoPickerActivity extends MyBaseActivity implements PhotoAdapter.PhotoClickCallBack {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (mPhotoAdapter.isShowCamera() && position == 0) {
                    ...
                    if (ContextCompat.checkSelfPermission(PhotoPickerActivity.this, android.Manifest.permission.CAMERA)
                            != PackageManager.PERMISSION_GRANTED) {
                        ActivityCompat.requestPermissions(PhotoPickerActivity.this,new String[] {android.Manifest.permission.CAMERA},
                                OPEN_CAMERA  );
                    }else {
                        //同意该权限则直接启动相机
                        showCamera();
...
//        }
        ...
        if(cameraIntent.resolveActivity(getPackageManager()) != null){
            ...
            if(Build.VERSION.SDK_INT>=Build.VERSION_CODES.N){
                Uri uriForFile = FileProvider.getUriForFile(PhotoPickerActivity.this, "com.sj.yinjiaoyun.xuexi.fileProvider", mTmpFile);
