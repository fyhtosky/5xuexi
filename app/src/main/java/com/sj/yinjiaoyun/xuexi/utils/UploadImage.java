            ...
            if(file!=null) {
                ...
                for(int i=0;i<params.length;i++){
                    ...
                    String sb = PREFIX +
                            BOUNDARY +
                            LINE_END +
                            "Content-Disposition: form-data; name=" + params[i] + LINE_END +
                            LINE_END +
                            values[i] +
                            LINE_END;
                ...
                String sb = PREFIX +
                        BOUNDARY +
                        LINE_END +
                        "Content-Disposition: form-data; name=\"data\";filename=" + "\"" + file.getName() + "\"" + LINE_END +
                        "Content-Type: image/jpg" + LINE_END +
                        LINE_END;
