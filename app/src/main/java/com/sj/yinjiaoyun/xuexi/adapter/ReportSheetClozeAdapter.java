 ...
 */
public class ReportSheetClozeAdapter extends RecyclerView.Adapter {
    private Context context;
    private List<TiMu> tmList;
    private int jobState;
    private OnItemClickListener mOnItemClickListener = null;

    public ReportSheetClozeAdapter(Context context, List<TiMu> tmList, int jobState) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        ReportClozeItemAdapter itemAdapter = new ReportClozeItemAdapter(context, tm.getChildrenList(), jobState);
