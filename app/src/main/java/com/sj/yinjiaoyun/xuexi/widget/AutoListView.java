...
public class AutoListView extends ListView implements OnScrollListener {
	...
	public void onRefreshComplete() {
		String currentTime = TimeCutTamp.getCurrentTime();
	...
	public void onScroll(AbsListView view, int firstVisibleItem,
		...
		//Log.i("message", "onScroll: "+firstVisibleItem+":"+visibleItemCount+":"+totalItemCount);
	...
	//Log.i("message", "scrollState: "+scrollState);
