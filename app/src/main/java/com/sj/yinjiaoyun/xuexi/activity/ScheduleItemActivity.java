...
import com.sj.yinjiaoyun.xuexi.fragment.GradeFragment;
import com.sj.yinjiaoyun.xuexi.fragment.IntroFragment;
 ...
 * 专业课程详情页面
 * 根据课程表ID获取学员课程章节课时信息列表及学习情况
 */
public class ScheduleItemActivity extends PlayBaseActivity implements DirectoryFragment.FragmentCallBack, UniversalVideoView.VideoViewCallback, HttpDemo.HttpCallBack {


    private static final int VIEWPAGER_DEFAULT_HEIGHT = 100;
    /////////////////////////////视频控件的设置/////////////////////////////////////////////////////
    private static final String SEEK_POSITION_KEY = "SEEK_POSITION_KEY";
    private  int mSeekPosition;//当前视屏播放的当前位置
    String TAG = "scheduleitem";
    CourseVO courseVO;//课程
    Coursewares wares;//课程详情-章节课时列表及学习情况
    SoaProductVO soaProductVO;//某个专业信息封装类
    LayoutInflater inflater;
    ViewPager viewPager;
    RadioGroup group;//简介 目录  成绩
    FragmentAdapter fragmentAdapter;
    List<Fragment> listFragment;
    IntroFragment introFragment;//简介
    DirectoryFragment directoryFragment;//目录
    GradeFragment gradeFragment;//成绩
...
//    UniversalMediaController mMediaController;//视频控制控件
     ...
     * 启动Activity
     */
    public static void StartActivity(Context context, String courseScheduleId, String courseName, String courseId, String coursePercent) {
        ...
        intent.putExtra("coursePercent", coursePercent);
    ...
    protected int layoutID() {
        return R.layout.layout_scheduleitem;
    }
    ...
    private void init() {
        ...
        endUserId = PreferencesUtils.getSharePreStr(ScheduleItemActivity.this, "username");
        Bundle bundle = getIntent().getExtras();
        if (bundle != null) {
            courseScheduleId = bundle.getString("courseScheduleId");
            courseName = bundle.getString("courseName");
            courseId = bundle.getString("courseId");
            coursePercent = bundle.getString("coursePercent");
        }
    }
//    //关于视频控件事件的绑定
...
//                Log.e("videos", "onCompletion 监听视屏播放完成" + totalPlayTime);
//                mSeekPosition = 0;
//                mVideoView.pause();
...
//                Log.i("videos", "onError: ");
//                ToastUtil.showShortToast(ScheduleItemActivity.this,"错误代码："+what+";="+extra);
//                return false;
//            }
//        });
...
//            mVideoView.showControlView();
    ...
    private void setVideoPlayerBefore(final String title, final String video) {
        Log.i(TAG, "setVideoPlayerBefore: " + "检查网络信息" + video);
    ...
    protected PLPlayView findPlayView() {
        return (PLPlayView) findViewById(R.id.video_layout);
    }
...
//        mVideoView.getmPLVideoView().seekTo(mSeekPosition);
    ...
    protected boolean onPlayError(int i) {
        ToastUtil.showShortToast(ScheduleItemActivity.this, "错误代码：" + i);
        return false;
    }
...
//        Log.i("videos", "videoTickling: " + courseVO.toString());
...
//        pairsList.add(new Pairs("courseScheduleId", String.valueOf(courseVO.getCourseScheduleId())));//课程表ID
        pairsList.add(new Pairs("courseScheduleId", courseScheduleId));//课程表ID
//        pairsList.add(new Pairs("courseId", String.valueOf(courseVO.getCourseId())));//Long	是	课程id
...
//        }
    ...
    private void initView() {
        flashContainer = findViewById(R.id.schedule_underLineC);
        group = (RadioGroup) findViewById(R.id.item_head_group);
        viewPager = (ViewPager) findViewById(R.id.item_home_viewpager);
        mViewTitle = (TextView) findViewById(R.id.view_title);
//        mViewTitle.setText(courseVO.getCourseName());//设置视屏中的标题
...
//        mMediaController = (UniversalMediaController) findViewById(R.id.media_controller);
            ...
            public void onPageSelected(int position) {
                ...
                switch (position){
                    case 0:
                        break;
                    case 1:
                        directoryFragment.setDateFromActivity(courseScheduleId, ScheduleItemActivity.this);
                        break;
                    case 2:
                        gradeFragment.setDateFromActivity(coursePercent, courseScheduleId);
                        break;
                }
            }
    ...
    //创建 简介 目录 成绩 的fragment数据
    private void createFragmentData() {
        listFragment = new ArrayList<>();
        directoryFragment = new DirectoryFragment();
//        directoryFragment.setDateFromActivity(String.valueOf(courseVO.getCourseScheduleId()), ScheduleItemActivity.this);
        directoryFragment.setDateFromActivity(courseScheduleId, ScheduleItemActivity.this);
        introFragment = new IntroFragment();//简介
//        introFragment.setDateFromActivity(String.valueOf(courseVO.getCourseScheduleId()));//选课表id
        introFragment.setDateFromActivity(courseScheduleId);//选课表id
        gradeFragment = new GradeFragment();//分数
//        gradeFragment.setDateFromActivity(courseVO);//课程id
        gradeFragment.setDateFromActivity(coursePercent, courseScheduleId);
//        Log.i(TAG, "createFragmentData: " + courseVO.toString());

        listFragment.add(introFragment);
        listFragment.add(directoryFragment);
        listFragment.add(gradeFragment);
    }
...
//        mVideoView.pausePlay();
    ...
    public void deliveryUri(Coursewares coursewares, int currentTime, int totalPlayTime, int playCount) {
        Log.i(TAG, "deliveryUri: " + currentTime + ":" + coursewares.toString());
...
//            setVideoPlayerBefore(coursewares.getCoursewareName(), VIDEO_URL);
    ...
    public void deliverTime(long totalTime) {
        ...
        if (gradeFragment != null)
            gradeFragment.setTotalTimeFromActivity(totalTime);
        Log.i("cccc", "Activity: " + totalTime);
    }
